...
Note: change WORLD_NAME on line 48 if your world isn't named "MyWorld"
"""
...
def copy_files(file_paths, new_dir):
    ...
    for file_path in file_paths:
        ...
        shutil.copy2(file_path.absolute(), destination.absolute())
...
def backup_old_world():
    ...
    if len(present_world_files) == 4:
        ...
        print(f'Hittade inga jävla filer för "{WORLD_NAME}" i\n\t{WORLDS_FOLDER}')
        print("Antingen är skiten redan back-uppad eller så finns inga jävla filer.")
    else:
        print("WTH, dude. SOmething is wrong in your files and shit")
...
def move_gitted_world_to_appdata():
    ...
    if len(gitted_files) == 4:
        ...
        print(f'HELVETE! Inga världsfiler i repot för "{WORLD_NAME}"')
